...
//        INSERT INTO `products`(`id`, `name`, `price`, `thumbnail`, `category_id`, `discount`, `description`, `content`, `author`, `publishing_date`, `publishing_company`, `number_of_pages`, `size`, `is_deleted`, `created_at`, `updated_at`) VALUES ('One Piece 63','19500','op63.jpg','2','10', 'Tiểu thuyết thiếu niên','One Piece là bộ manga dành cho lứa tuổi thiếu niên của tác giả Eiichiro Oda, được đăng định kì trên tạp chí Weekly Shōnen Jump, ra mắt lần đầu trên ấn bản số 34 vào ngày 19 tháng 7 năm 1997.', 'Eiichiro Oda','2016/10/11','NXB Kim Đồng','260','13,5 cm x 19,5 cm','0');
